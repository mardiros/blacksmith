...
) -> AsyncClientFactory[ServiceRequest, Service, Any, Any]:
    sd = AsyncStaticDiscovery({("consul", "v1"): endpoint})
    fact: AsyncClientFactory[ServiceRequest, Service, Any, Any] = AsyncClientFactory(
...
class AsyncConsulDiscovery(AsyncAbstractServiceDiscovery):
    ...
    def __init__(
        ...
        _client_factory: Callable[
            [Url, str], AsyncClientFactory[ServiceRequest, Service, Any, Any]
        ] = blacksmith_cli,
    ) -> None:
